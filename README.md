...
* The weight editing menu can stop rendering when editing a container type; you might have to re-open the container item during configuration. I am working on a fix.
* Currently, you have to set the weight of every item manually. I am working on a system that automatically creates a clone of your compendium with pre-determined item weights. 

## Disclaimer

As someone very much new to this, I have enlisted the help of AI during parts of this project.
